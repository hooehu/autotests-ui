...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.courses_chart = page.get_by_test_id('courses-line-chart')
        self.scores_title = page.get_by_test_id('scores-widget-title-text')
        self.scores_chart = page.get_by_test_id('scores-line-chart')
    ...
    def check_visible_students_chart(self):
        self.navbar_component.check_visible('username')
