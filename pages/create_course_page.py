...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.create_course_exercise_form_component = (
            CreateCourseExerciseFormComponent(page)
        )
        self.create_course_toolbar_view_component = (
            CreateCourseToolbarViewComponent(page)
        )
