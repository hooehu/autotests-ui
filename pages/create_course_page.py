...
from components.coursers.create_course_exercise_component import CreateCourseExerciseFormComponent
from components.navigation.navbar_component import NavbarComponent
from components.views.empty_view_component import EmptyViewComponent
from components.views.image_upload_widget import ImageUploadWidget
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.image_upload_widget = ImageUploadWidget(page, identifier='create-course-preview')
